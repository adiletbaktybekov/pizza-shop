    ...
    return (
        <div>
            ...
            <Accordion title="Где находимся мы?">
                <p className="text-gray-700">Мы находимся в городе Москва, Кузмынской метро, ул. Волгоградский, 177 <a href="https://www.google.com/maps/place/MY+Sushi/@55.701692,37.795568,17z/data=!4m6!3m5!1s0x414ab5944808dc93:0xf70cee9a4e35e717!8m2!3d55.701906!4d37.795714!16s%2Fg%2F11r9vmc9_g" target="_blank" className="text-blue-400">Можете посмотреть здесь</a></p>
            </Accordion>
            <Accordion title="Доставка есть?">
                <p className="text-gray-700">Да, Мы предлагаем доставку пиццы на дом или в офис, а также бесплатная доставка от 1500 руб. Оплата производится наличными, или картой курьеру при получении заказа.</p>
            </Accordion>
        </div>
    );
};
