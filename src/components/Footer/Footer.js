...
const Footer = () => {
    return (
        <section className="footer bg-black w-full">
            <div className="container">
                ...
                <div className="text-xl border-b border-gray-500  text-white pt-[50px] pb-[50px] flex flex-row flex-wrap justify-between">
                    ...
                    <div className="mx-[50px] my-[20px] flex flex-col">
