    ...
    return (
        <div className="about py-[150px]">
            <div className="container">
                ...
                <h1 className="text-xl my-7">Мы приглашаем вас посетить нашу пиццерию и попробовать наши блюда. Мы
                    предлагаем уютную и дружественную атмосферу, идеальную для семейного ужина, встречи с друзьями или
                    романтического ужина вдвоем. Мы также предлагаем услугу доставки пиццы, чтобы вы могли насладиться
                ...
                <div className="about-first flex justify-between">
                    ...
                    <div className="about-second-text flex flex-col ml-[100px]">
                        ...
                        <h1 className=" my-[20px] text-xl">С самого начала мы стремимся к тому, чтобы наши гости
                            ...
                            дружелюбный сервис и теплую атмосферу. Мы гордимся тем, что наша пиццерия стала любимым
                            местом для многих людей, и мы будем продолжать работать над тем, чтобы удивлять и радовать
                            наших гостей каждый день.</h1>
                        <h1 className=" my-[20px] text-xl">Мы верим, что хорошая пицца - это не только вкусно, но и
